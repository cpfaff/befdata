...
ActiveRecord::Schema.define(version: 20_140_920_175_135) do
  ...
  add_index 'author_paperproposals', %w(user_id paperproposal_id), name: 'index_author_paperproposals_on_user_id_and_paperproposal_id'
  ...
  add_index 'dataset_downloads', %w(user_id dataset_id), name: 'index_dataset_downloads_on_user_id_and_dataset_id'
  ...
  add_index 'dataset_paperproposals', %w(dataset_id paperproposal_id), name: 'index_dataset_paperproposals_on_dataset_id_and_paperproposal_id'
  ...
  add_index 'datasets_projects', %w(dataset_id project_id), name: 'index_dataset_projects_on_dataset_id_and_project_id'
  ...
  add_index 'freeformats', %w(freeformattable_type freeformattable_id), name: 'idx_freeformats_type_id'
  ...
  add_index 'roles', %w(authorizable_type authorizable_id), name: 'index_roles_on_authorizable_type_and_authorizable_id'
  ...
  add_index 'roles_users', %w(user_id role_id), name: 'index_roles_users_on_user_id_and_role_id'
  ...
  add_index 'sheetcells', %w(status_id datacolumn_id), name: 'index_sheetcells_on_status_id_and_datacolumn_id'
