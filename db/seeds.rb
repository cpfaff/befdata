...
if Rails.env != 'performance'
  ...
  while i < 5000
    ...
    person.crypted_password = i.to_s
    person.password_salt = i.to_s
    person.persistence_token = i.to_s
    person.single_access_token = i.to_s
    person.perishable_token = i.to_s
